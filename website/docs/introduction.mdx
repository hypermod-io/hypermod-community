...
This project provides library users & maintainers with facilities to help [write](authoring), [test](testing), [publish](contribution) and [consume](docs/consuming) codemods in a structured and familiar way.
