...
title: Introduction
slug: /
description: 'Welcome to the codeshiftcommunity. This is a community of developers who use Hypermod to automatically refactor their codebase. Join us to learn more about Hypermod, share your own codemods, and collaborate with others.'
...
CodeshiftCommunity offers a platform-agnostic toolchain for creating, publishing, and using codemods, centered around the @hypermod/cli. This CLI provides common infrastructure and eliminates the need for developers to constantly recreate the same tools.
